...
.PHONY : pegasus-start
pegasus-start: $(PEGASUS_OWN_REPOSITORY) $(PEGASUS_START_CONF)

.PHONY : pegasus-stop
pegasus-stop : $(PEGASUS_START_CONF) 
	PATH=$(PATH_WITH_PEGASUS) $(PEGASUS_SERVER) -s

$(PEGASUS_START_CONF) : pegasus-start-command | $(PEGASUS_OWN_REPOSITORY)

.PHONY : pegasus-start-command
pegasus-start-command :
