...
PEGASUS_COMPONENTS=$(PEGASUS_SERVER) $(CIM_SCHEMA_DIR) \
...
$(PEGASUS_COMPONENTS) : export PEGASUS_CIM_SCHEMA=$(PEGASUS_SCHEMA_DIR)
$(PEGASUS_COMPONENTS) : export PEGASUS_DISABLE_PROV_USERCTXT=1
$(PEGASUS_COMPONENTS) : export PATH := $(PEGASUS_BINPATH):$(PATH)

$(PEGASUS_SERVER): $(PEGASUS_UPSTREAM_TARBALL) $(CIM_SCHEMA_DIR)
	tar xzf $<
...
$(PEGASUS_IMP_REPOSITORY) : $(PEGASUS_OWN_REPOSITORY)
	$(PGCIMMOFL) -aE -R$(PEGASUS_HOME) -Nrepository -n$(IMP_NAMESPACE) \
					$(CIM_SCHEMA_DIR)/Core_Qualifiers.mof
...
$(PEGASUS_START_CONF) :
	$(PEGASUS_SERVER) $(PEGASUS_RUN_OPTS)
...
patch-pegasus-schema: $(CIM_SCHEMA_DIR)
