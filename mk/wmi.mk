...
override target_CPPFLAGS = -I. -DSF_IMPLEMENTATION_NS=\"$(IMP_NAMESPACE)\" -DSF_INTEROP_NS=\"$(INTEROP_NAMESPACE)\" -DCIMPLE_WMI_MODULE
override target_CXXFLAGS = -Wall -W -Wno-unused -Werror -g -fms-extensions -Wno-unknown-pragmas -std=gnu++98
override target_LDFLAGS = link.def -static-libgcc -static-libstdc++ -Wl,--kill-at
