...
#define efrm_vi_attr_init(client, attr)					\
      __efrm_vi_attr_init((client), (attr), sizeof(struct efrm_vi_attr))
extern int __efrm_vi_attr_init(struct efrm_client *client,
 ...
 *
 * [attr] may be NULL, in which case the VI has default attributes.
 */
...
struct pci_dev;
extern struct pci_dev *efrm_vi_pci_dev(struct efrm_vi *virs);
...
extern void efrm_vi_resource_free(struct efrm_vi *);
