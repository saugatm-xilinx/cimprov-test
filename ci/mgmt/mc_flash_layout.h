...
/* Encoding of the boot offset as passed by the boot ROM: the
 * offset is bits 0 - (MC_BOOT_CSEL_BITPOS - 1), the chipsel
 * is bits MC_BOOT_CSEL_BITPOS - 31 */
#define MC_BOOT_CSEL_BITPOS (28)
#define MC_BOOT_CSEL_MASK (0xf << MC_BOOT_CSEL_BITPOS)
