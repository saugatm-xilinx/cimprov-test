...
ci_inline void ci_atomic32_and (ci_uint32 *a, int v)
{
	// Perform   a &= v
...
ci_inline void ci_atomic32_or (ci_uint32 *a, int v)
{
	// Perform   a->n |= v
...
ci_inline void ci_atomic32_add (ci_uint32 *a, int v)
{
   int	t;
   __asm__ __volatile__(
      "1:     lwarx   %0,0,%2     \n"
...
ci_inline unsigned int ci_cas32(volatile ci_uint32 *p, ci_uint32 old, ci_uint32 new)
...
ci_inline int ci_cas32_succeed(volatile ci_uint32* p, ci_uint32 oldval, ci_uint32 newval)
{ return (int)(ci_cas32(p, oldval, newval) == oldval); }

ci_inline int ci_cas32_fail(volatile ci_uint32* p, ci_uint32 oldval, ci_uint32 newval)
{ return (int)(ci_cas32(p, oldval, newval) != oldval); }
...
#define ci_spinloop_pause() 		/* YET to deal with this !!!*/
