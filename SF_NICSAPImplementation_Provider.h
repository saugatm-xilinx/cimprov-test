...
#ifndef _SF_NICSAPImplementation_Provider_h
#define _SF_NICSAPImplementation_Provider_h
...
public:
    ...
    SF_NICSAPImplementation_Provider();
...
#endif /* _SF_NICSAPImplementation_Provider_h */
