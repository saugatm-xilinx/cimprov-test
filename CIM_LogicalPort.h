...
#ifndef _cimple_CIM_LogicalPort_h
#define _cimple_CIM_LogicalPort_h
...
/*[1194]*/
class CIM_LogicalPort : public Instance
{
public:
    ...
    CIMPLE_CLASS(CIM_LogicalPort)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_LogicalPort_RequestStateChange_method;

typedef CIM_LogicalDevice_SetPowerState_method CIM_LogicalPort_SetPowerState_method;

typedef CIM_LogicalDevice_Reset_method CIM_LogicalPort_Reset_method;

typedef CIM_LogicalDevice_EnableDevice_method CIM_LogicalPort_EnableDevice_method;

typedef CIM_LogicalDevice_OnlineDevice_method CIM_LogicalPort_OnlineDevice_method;

typedef CIM_LogicalDevice_QuiesceDevice_method CIM_LogicalPort_QuiesceDevice_method;

typedef CIM_LogicalDevice_SaveProperties_method CIM_LogicalPort_SaveProperties_method;

typedef CIM_LogicalDevice_RestoreProperties_method CIM_LogicalPort_RestoreProperties_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_LogicalPort_h */
