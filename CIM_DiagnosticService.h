...
#ifndef _cimple_CIM_DiagnosticService_h
#define _cimple_CIM_DiagnosticService_h
...
/*[1194]*/
class CIM_DiagnosticService : public Instance
{
public:
    ...
    CIMPLE_CLASS(CIM_DiagnosticService)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_DiagnosticService_RequestStateChange_method;

typedef CIM_Service_StartService_method CIM_DiagnosticService_StartService_method;

typedef CIM_Service_StopService_method CIM_DiagnosticService_StopService_method;

typedef CIM_Service_ChangeAffectedElementsAssignedSequence_method CIM_DiagnosticService_ChangeAffectedElementsAssignedSequence_method;

/*[1280]*/
class CIM_DiagnosticService_RunDiagnostic_method : public Instance
{
public:
    CIM_ManagedElement* ManagedElement;
    CIM_DiagnosticSetting* DiagSetting;
    CIM_JobSettingData* JobSetting;
    CIM_ConcreteJob* Job;
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiagnosticService_RunDiagnostic_method)
};

/*[1280]*/
class CIM_DiagnosticService_RunDiagnosticService_method : public Instance
{
public:
    CIM_ManagedElement* ManagedElement;
    CIM_DiagnosticSettingData* DiagnosticSettings;
    CIM_JobSettingData* JobSettings;
    CIM_ConcreteJob* Job;
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiagnosticService_RunDiagnosticService_method)
};

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_DiagnosticService_h */
