...
#ifndef _cimple_CIM_Log_h
#define _cimple_CIM_Log_h
...
typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_Log_RequestStateChange_method;

/*[1280]*/
class CIM_Log_ClearLog_method : public Instance
{
public:
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_Log_ClearLog_method)
};

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_Log_h */
