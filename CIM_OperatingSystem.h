...
#ifndef _cimple_CIM_OperatingSystem_h
#define _cimple_CIM_OperatingSystem_h
...
/*[1194]*/
class CIM_OperatingSystem : public Instance
{
public:
    ...
    Property<Datetime> LastBootUpTime;
    Property<Datetime> LocalDateTime;
    Property<sint16> CurrentTimeZone;
    Property<uint32> NumberOfLicensedUsers;
    Property<uint32> NumberOfUsers;
    Property<uint32> NumberOfProcesses;
    Property<uint32> MaxNumberOfProcesses;
    Property<uint64> TotalSwapSpaceSize;
    Property<uint64> TotalVirtualMemorySize;
    Property<uint64> FreeVirtualMemory;
    Property<uint64> FreePhysicalMemory;
    Property<uint64> TotalVisibleMemorySize;
    Property<uint64> SizeStoredInPagingFiles;
    Property<uint64> FreeSpaceInPagingFiles;
    Property<uint64> MaxProcessMemorySize;
    Property<boolean> Distributed;
    Property<uint32> MaxProcessesPerUser;

    CIMPLE_CLASS(CIM_OperatingSystem)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_OperatingSystem_RequestStateChange_method;

/*[1280]*/
class CIM_OperatingSystem_Reboot_method : public Instance
{
public:
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_OperatingSystem_Reboot_method)
};

/*[1280]*/
class CIM_OperatingSystem_Shutdown_method : public Instance
{
public:
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_OperatingSystem_Shutdown_method)
};

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_OperatingSystem_h */
