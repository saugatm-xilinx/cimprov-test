...
_CIM_RecordAppliesToElement_Antecedent =
{
    ...
    CIMPLE_OFF(CIM_RecordAppliesToElement,Antecedent)
};
...
_CIM_RecordAppliesToElement_Dependent =
{
    ...
    CIMPLE_OFF(CIM_RecordAppliesToElement,Dependent)
};

/*[2291]*/
static Meta_Feature* _CIM_RecordAppliesToElement_MFA[] =
{
...
/*[2358]*/
const Meta_Class CIM_RecordAppliesToElement::static_meta_class =
{
    CIMPLE_ATOMIC_INITIALIZER, /* refs */
    ...
    0, /* meta_qualifiers */
    0, /* num_meta_qaulifiers */
    _CIM_RecordAppliesToElement_MFA,
    CIMPLE_ARRAY_SIZE(_CIM_RecordAppliesToElement_MFA),
    sizeof(CIM_RecordAppliesToElement),
    _locals,
