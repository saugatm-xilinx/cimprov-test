...
#ifdef _WIN32
/* From observation & socket tester */
# define CI_CFG_TCP_FIN_TIMEOUT         120
#else
...
#else
#define CI_CFG_USERSPACE_EPOLL          0
#endif
 ...
 */
#ifdef __sun__
#define CI_CFG_POSIX_CONNECT_AFTER_LISTEN   1
#else
...
#ifdef TCP_CHIMNEY_SUPPORT
# define CI_CFG_CHIMNEY                 1
/* Number of RX completions to batch.  16 is just a guess */
# define CI_CFG_CHIMNEY_RX_BATCH        0
#else
...
# else
#  define CI_CFG_UDP_SNDBUF_MIN		0
# endif
#endif
...
#else
# define CI_CFG_UDP_RCVBUF_MIN		0
#endif
...
#else
/*! \todo Windows defaults to 8192 & reports as such, however this may 
 * be ignored (see the comment for RCVBUF) */
# define CI_CFG_TCP_SNDBUF_DEFAULT	65535 /*8192*/
#endif
...
#else
/*! \todo Windows defaults to 8192 and report that value, however this 
 * appears to be taken as a hint - it advertises 65535. For now we will 
 * have to set to 65535 & take a hit on reporting the wrong default. */
# define CI_CFG_TCP_RCVBUF_DEFAULT	65535 /*8192*/
#endif
 ...
 */
#ifdef _WIN32
# define CI_CFG_ACCEPT_INHERITS_NONBLOCK 1
# define CI_CFG_ACCEPT_INHERITS_NODELAY  1
#elif defined(__sun__)
# define CI_CFG_ACCEPT_INHERITS_NONBLOCK 1
# define CI_CFG_ACCEPT_INHERITS_NODELAY  0
...
#ifdef _WIN32
/* Native windows behaves as if this option is 1 - but this may lose
 * performance.  Set this to 1 if conformance with Windows is paramount
 */
 ...
 */
#ifdef _WIN32
#define CI_CFG_NET_DHCP_FILTER 1
#else
 ...
 */
#if CI_CFG_ISCSI
# define CI_CFG_ISCSI_TX_DIGEST_OFFLOAD 1
# define CI_CFG_ISCSI_RX_DIGEST_OFFLOAD 1
#else
...
#endif
#ifdef __sun__
# undef  CI_CFG_SENDFILEV
# define CI_CFG_SENDFILEV  1
#endif
...
#if CI_CFG_CHIMNEY
/* Turn off some features that have no significance for chimney.  In some
 * cases we do this to avoid linkage problems.  In other cases it is to
 * avoid wasting space in data structures.
 *
 * Also turn on some optimisations...
 */
# undef  CI_CFG_STATS_TCP_LISTEN
# define CI_CFG_STATS_TCP_LISTEN          0
# undef  CI_CFG_TCP_LISTENQ_BUCKETS
# define CI_CFG_TCP_LISTENQ_BUCKETS       4
# undef  CI_CFG_RSS_HASH
# define CI_CFG_RSS_HASH                  1
# undef  CI_CFG_HW_TIMER
# define CI_CFG_HW_TIMER                  0
# undef  CI_CFG_UDP
# define CI_CFG_UDP                       0
# undef  CI_CFG_PP_IS_PTR
# define CI_CFG_PP_IS_PTR                 1
# undef  CI_CFG_OOP_IS_PTR
# define CI_CFG_OOP_IS_PTR                1
# undef  CI_CFG_SOCKP_IS_PTR
# define CI_CFG_SOCKP_IS_PTR              1
# undef  CI_CFG_NETIF_HARDEN
# define CI_CFG_NETIF_HARDEN              0
# undef  CI_CFG_CONG_AVOID_CONSERVATIVE_SLOW_START
# define CI_CFG_CONG_AVOID_CONSERVATIVE_SLOW_START 0
/* It is a MUST NOT to set this more than 2 according to RFC3465 but
 * Microsoft mandate 4 in their logo requirements document for
 * chimney */
# undef  CI_CFG_CONG_AVOID_RFC3465_L_VALUE  
# define CI_CFG_CONG_AVOID_RFC3465_L_VALUE 4
# undef  CI_CFG_TCP_FASTSTART
# define CI_CFG_TCP_FASTSTART             0
#endif
