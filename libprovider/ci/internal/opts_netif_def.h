...
#if CI_CFG_CHIMNEY
CI_CFG_OPT("EF_RX_DIRECT", rx_direct, ci_uint32,
"doc",
           1, , 1, 0, 1, yesno)
#endif
...
"separation between different stacks or net driver packets.  The process "
"should be owned by root to use this mode."
"\n"
...
"in the same way as (2).  Only root can use it."
"\n"
...
"socket (client should allow this via EF_TCP_CLIENT_LOOPBACK=2).",
           2, , CITP_TCP_LOOPBACK_OFF, 0, 2, oneof:no;samestack;toconn)
...
"NOTE: Option 3 breaks some usecases with epoll, fork and dup calls.\n",
           2, , CITP_TCP_LOOPBACK_OFF, 0, 3, oneof:no;samestack;toconn;tolist)
