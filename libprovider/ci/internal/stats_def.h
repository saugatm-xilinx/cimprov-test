...
#ifdef _WIN32
# if CI_CFG_CHIMNEY
OO_STAT("Number of times transmit was limited by window.",
        ci_uint32, tx_window_limited, count)
OO_STAT("Number of times transmit was limited by application.",
        ci_uint32, tx_app_limited, count)
OO_STAT("Number of times transmit was limited by txq_limit.",
        ci_uint32, tx_q_limited, count)
OO_STAT("Number of rx completions",
        ci_uint32, rx_completions, count)
OO_STAT("Number of rx NBLs completed",
        ci_uint32, rx_completed_nbls, count)
OO_STAT("Number of rx bytes that bypass the receive queue",
        ci_uint32, rx_bytes_direct, count)
OO_STAT("Number of rx bytes delivered when app posts a buffer",
        ci_uint32, rx_bytes_app, count)
OO_STAT("Number of rx bytes delivered via recv-q when segments arrive",
        ci_uint32, rx_bytes_recv, count)
OO_STAT("Number of rx bytes delivered by indicate",
        ci_uint32, rx_bytes_indicate, count)
OO_STAT("Number of rx bytes delivered when indicate completes",
        ci_uint32, rx_bytes_post_indicate, count)
OO_STAT("Number of connections offloaded",
        ci_uint32, offloads, count)
OO_STAT("Number of connections for which terminate has been requested",
        ci_uint32, terminate_start, count)
OO_STAT("Number of connections terminated",
        ci_uint32, terminated, count)
# else
OO_STAT("Number of times we've switched address space in unlock callback",
        ci_uint32, addr_space_switch, count)
# endif
#endif
