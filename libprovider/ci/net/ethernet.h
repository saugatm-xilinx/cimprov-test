...
# define ETH_ZLEN      ETHERMIN
# define ETH_HLEN      ((uint_t) sizeof (struct ether_header))
# define ETH_DATA_LEN  ETHERMTU
# define ETH_FRAME_LEN ETHERMAX
...
# define ETH_DATA_LEN	(ETHER_MAX_LEN - ETHER_HDR_LEN - ETHER_CRC_LEN)
...
#else
# error "ETH_* not defined for this platform"
#endif
