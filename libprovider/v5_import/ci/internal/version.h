...
#define CI_MIN_RELEASE_VERSION            (13)
#define CI_MAINT_RELEASE_VERSION          (0)
#define CI_INCREMENTING_VERSION           (1006)
#define CI_VERSION_STRING                 "v4.13.0.1006"
