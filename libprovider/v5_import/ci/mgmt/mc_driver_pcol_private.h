...
/* enum: Enable/disable user threshold for thge specified port */
...
#define    MC_CMD_EFTEST_CTPIO_MAP_STATS_IN_LENMAX ((((64-1+(32* max))+1))>>3)
...
#define       MC_CMD_EFTEST_CTPIO_MAP_STATS_IN_MAPPING_MAXNUM  max
...
/* enum: Get TX autopadding configuration for given port number */
#define          MC_CMD_EFTEST_MAC_TX_AUTOPAD_IN_GET  0x0
/* enum: Set TX autopadding configuration for given port number */
...
/* MC_CMD_EFTEST_CRAGIT_START_OUT msgresponse */
/*         MC_CMD_EFTEST_CRAGIT_START_OUT_LEN 0 */
