...
typedef enum image_subtype_bootrom_e {		/* GENERATED BY scripts/genfwdef */
	...
	IMAGE_SUBTYPE_BOOTROM_MEDFORD2 = 7,
...
typedef enum image_subtype_mcfw_e {		/* GENERATED BY scripts/genfwdef */
	...
	IMAGE_SUBTYPE_MCFW_ICARUS = 33,
	IMAGE_SUBTYPE_MCFW_JERICHO = 34,
	IMAGE_SUBTYPE_MCFW_BYBLOS = 35,
	IMAGE_SUBTYPE_MCFW_GROAT = 36,
	IMAGE_SUBTYPE_MCFW_SHILLING = 37,
	IMAGE_SUBTYPE_MCFW_FLORIN = 38,
	IMAGE_SUBTYPE_MCFW_THREEPENCE = 39,
	IMAGE_SUBTYPE_MCFW_CYCLOPS = 40,
	IMAGE_SUBTYPE_MCFW_PENNY = 41,
	IMAGE_SUBTYPE_MCFW_BOB = 42,
...
typedef enum image_subtype_mumfw_e {		/* GENERATED BY scripts/genfwdef */
	...
	IMAGE_SUBTYPE_MUMFW_ICARUS = 2,           /* Malaga MUM firmware */
	IMAGE_SUBTYPE_MUMFW_JERICHO = 3,          /* Emma MUM firmware */
	IMAGE_SUBTYPE_MUMFW_BYBLOS = 4,           /* Pagnell MUM firmware */
	IMAGE_SUBTYPE_MUMFW_SHILLING = 5,         /* Bradford R1.x MUM firmware */
	IMAGE_SUBTYPE_MUMFW_FLORIN = 6,           /* Bingley MUM firmware */
	IMAGE_SUBTYPE_MUMFW_THREEPENCE = 7,       /* Baildon MUM firmware */
	IMAGE_SUBTYPE_MUMFW_CYCLOPS = 8,          /* Talbot MUM firmware */
	IMAGE_SUBTYPE_MUMFW_PENNY = 9,            /* Batley MUM firmware */
	IMAGE_SUBTYPE_MUMFW_BOB = 10,             /* Bradford R2.x MUM firmware */
} image_subtype_mumfw_t;

typedef enum image_subtype_uefirom_e {		/* GENERATED BY scripts/genfwdef */
	IMAGE_SUBTYPE_UEFIROM_ALL = 0,
