...
/* enum: Prefer to use firmware with maximum packet rate (DPDK) */
#define          MC_CMD_FW_PACKET_RATE 0x6
...
#define    MC_CMD_MUM_OUT_READ_DDR_INFO_LEN(num) (8+umul(8,(num)))
...
#define    MC_CMD_INIT_EVQ_V2_IN_LEN(num) (36+umul(8,(num)))
/* Size, in entries */
 ...
 * description see SF-119419-TC. This mode is only supported by "packet_rate"
 * datapath firmware.
 */
 ...
 * included as part of DPDK, used in conjunction with the packet_rate datapath
 * firmware variant.
 */
...
/* Set an action for all packets matching this filter. The DPDK driver and
 * packet_rate f/w variant use their own specific delivery structures, which
 * are documented in the DPDK Firmware Driver Interface (SF-119419-TC).
 * Requesting anything other than MATCH_ACTION_NONE when the NIC is running
 * another f/w variant will cause the filter insertion to fail with ENOTSUP.
 */
 ...
 * filter (only with packet_rate firmware, otherwise fails with ENOTSUP). Used
 * to support the DPDK rte_flow "FLAG" action.
 */
 ...
 * the filter (only with packet_rate firmware, otherwise fails with ENOTSUP).
 * Used to support the DPDK rte_flow "MARK" action.
 */
...
#define          MC_CMD_GET_CAPABILITIES_OUT_RXDP_PACKET_RATE  0x6
...
#define          MC_CMD_GET_CAPABILITIES_OUT_TXDP_PACKET_RATE  0x6
...
#define          MC_CMD_GET_CAPABILITIES_OUT_RXPD_FW_TYPE_PACKET_RATE  0xa
...
#define          MC_CMD_GET_CAPABILITIES_OUT_TXPD_FW_TYPE_PACKET_RATE  0xa
/* enum: RX PD firmware for GUE parsing prototype (Medford development only) */
...
/* enum: Packet rate RXDP firmware */
#define          MC_CMD_GET_CAPABILITIES_V2_OUT_RXDP_PACKET_RATE  0x6
/* enum: BIST RXDP firmware */
...
/* enum: Packet rate TXDP firmware */
#define          MC_CMD_GET_CAPABILITIES_V2_OUT_TXDP_PACKET_RATE  0x6
/* enum: BIST TXDP firmware */
...
/* enum: Packet rate RX PD production firmware */
#define          MC_CMD_GET_CAPABILITIES_V2_OUT_RXPD_FW_TYPE_PACKET_RATE  0xa
/* enum: RX PD firmware for GUE parsing prototype (Medford development only) */
...
/* enum: Packet rate TX PD production firmware */
#define          MC_CMD_GET_CAPABILITIES_V2_OUT_TXPD_FW_TYPE_PACKET_RATE  0xa
/* enum: RX PD firmware for GUE parsing prototype (Medford development only) */
...
/* enum: Packet rate RXDP firmware */
#define          MC_CMD_GET_CAPABILITIES_V3_OUT_RXDP_PACKET_RATE  0x6
/* enum: BIST RXDP firmware */
...
/* enum: Packet rate TXDP firmware */
#define          MC_CMD_GET_CAPABILITIES_V3_OUT_TXDP_PACKET_RATE  0x6
/* enum: BIST TXDP firmware */
...
/* enum: Packet rate RX PD production firmware */
#define          MC_CMD_GET_CAPABILITIES_V3_OUT_RXPD_FW_TYPE_PACKET_RATE  0xa
/* enum: RX PD firmware for GUE parsing prototype (Medford development only) */
...
/* enum: Packet rate TX PD production firmware */
#define          MC_CMD_GET_CAPABILITIES_V3_OUT_TXPD_FW_TYPE_PACKET_RATE  0xa
/* enum: RX PD firmware for GUE parsing prototype (Medford development only) */
...
/* enum: Packet rate RXDP firmware */
#define          MC_CMD_GET_CAPABILITIES_V4_OUT_RXDP_PACKET_RATE  0x6
/* enum: BIST RXDP firmware */
...
/* enum: Packet rate TXDP firmware */
#define          MC_CMD_GET_CAPABILITIES_V4_OUT_TXDP_PACKET_RATE  0x6
/* enum: BIST TXDP firmware */
...
/* enum: Packet rate RX PD production firmware */
#define          MC_CMD_GET_CAPABILITIES_V4_OUT_RXPD_FW_TYPE_PACKET_RATE  0xa
/* enum: RX PD firmware for GUE parsing prototype (Medford development only) */
...
/* enum: Packet rate TX PD production firmware */
#define          MC_CMD_GET_CAPABILITIES_V4_OUT_TXPD_FW_TYPE_PACKET_RATE  0xa
/* enum: RX PD firmware for GUE parsing prototype (Medford development only) */
...
#define    MC_CMD_PCIE_TUNE_RXEQ_SET_IN_LEN(num) (4+umul(4,(num)))
/* Requested operation */
...
#define    MC_CMD_LICENSING_GET_ID_V3_OUT_LEN(num) (8+umul(1,(num)))
...
#define    MC_CMD_XPM_READ_BYTES_OUT_LEN(num) (0+umul(1,(num)))
/* Data */
...
#define    MC_CMD_XPM_WRITE_BYTES_IN_LEN(num) (8+umul(1,(num)))
/* Start address (byte) */
...
#define    MC_CMD_XPM_READ_SECTOR_OUT_LEN(num) (4+umul(1,(num)))
/* Sector type */
...
#define    MC_CMD_XPM_WRITE_SECTOR_IN_LEN(num) (12+umul(1,(num)))
...
#define    MC_CMD_XPM_BLANK_CHECK_OUT_LEN(num) (4+umul(2,(num)))
...
#define    MC_CMD_GET_SECURITY_RULESET_VERSION_OUT_LEN(num) (0+umul(1,(num)))
...
#define    MC_CMD_SECURITY_RULE_COUNTER_ALLOC_OUT_LEN(num) (4+umul(4,(num)))
...
#define    MC_CMD_SECURITY_RULE_COUNTER_FREE_IN_LEN(num) (4+umul(4,(num)))
...
#define    MC_CMD_SUBNET_MAP_SET_NODE_IN_LEN(num) (4+umul(2,(num)))
...
#define    MC_CMD_REMOTE_PORTRANGE_MAP_SET_TREE_IN_LEN(num) (0+umul(4,(num)))
...
#define    MC_CMD_LOCAL_PORTRANGE_MAP_SET_TREE_IN_LEN(num) (0+umul(4,(num)))
/* PORTRANGE_TREE_NUM_ENTRIES new entries, each laid out as a
 * PORTRANGE_TREE_ENTRY
 */
...
#define    MC_CMD_SET_TUNNEL_ENCAP_UDP_PORTS_IN_LEN(num) (4+umul(4,(num)))
/* Flags */
...
#define    MC_CMD_TSA_BIND_IN_SET_KEY_LEN(num) (4+umul(1,(num)))
/* The operation requested. */
...
#define    MC_CMD_TSA_BIND_IN_UNBIND_EXT_LEN(num) (92+umul(1,(num)))
/* The operation requested. */
...
#define    MC_CMD_TSA_BIND_IN_DECOMMISSION_LEN(num) (108+umul(1,(num)))
...
#define    MC_CMD_TSA_BIND_IN_SECURE_UNBIND_LEN(num) (96+umul(1,(num)))
...
#define    MC_CMD_TSA_BIND_IN_SECURE_DECOMMISSION_LEN(num) (112+umul(1,(num)))
...
#define    MC_CMD_TSA_BIND_OUT_GET_ID_LEN(num) (14+umul(1,(num)))
...
#define    MC_CMD_TSA_BIND_OUT_GET_TICKET_LEN(num) (4+umul(1,(num)))
...
#define    MC_CMD_TSA_BIND_OUT_GET_CERTIFICATE_LEN(num) (8+umul(1,(num)))
...
#define    MC_CMD_MANAGE_SECURITY_RULESET_CACHE_OUT_LEN(num) (4+umul(1,(num)))
...
#define    MC_CMD_NVRAM_PRIVATE_APPEND_IN_LEN(num) (8+umul(1,(num)))
...
#define    MC_CMD_XPM_VERIFY_CONTENTS_OUT_LEN(num) (12+umul(1,(num)))
...
#define    MC_CMD_TSA_STATISTICS_IN_READ_CLEAR_LEN(num) (16+umul(4,(num)))
/* TSA statistics sub-operation code */
...
#define    MC_CMD_TSA_STATISTICS_OUT_READ_CLEAR_LEN(num) (8+umul(16,(num)))
...
#define    MC_CMD_TSA_CONFIG_IN_APPEND_LEN(num) (12+umul(1,(num)))
...
#define    MC_CMD_TSA_CONFIG_OUT_READ_LEN(num) (8+umul(1,(num)))
...
#define    MC_CMD_TSA_IPADDR_IN_VALIDATE_IPV4_LEN(num) (8+umul(8,(num)))
/* Header containing information to identify which sub-operation of this
 * command to perform. The header contains a 16-bit op-code. Unused space in
 * this field is reserved for future expansion.
 */
...
#define    MC_CMD_TSA_IPADDR_IN_REMOVE_IPV4_LEN(num) (8+umul(8,(num)))
/* Header containing information to identify which sub-operation of this
 * command to perform. The header contains a 16-bit op-code. Unused space in
 * this field is reserved for future expansion.
 */
...
#define    MC_CMD_GET_CERTIFICATE_OUT_LEN(num) (12+umul(1,(num)))
/* Type of the certificate. */
