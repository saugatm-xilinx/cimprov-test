...
#ifndef _cimple_SF_ConcreteJob_h
#define _cimple_SF_ConcreteJob_h
...
/*[1194]*/
class SF_ConcreteJob : public Instance
{
public:
    ...
    CIMPLE_CLASS(SF_ConcreteJob)
};

typedef CIM_Job_KillJob_method SF_ConcreteJob_KillJob_method;
...
#endif /* _cimple_SF_ConcreteJob_h */
