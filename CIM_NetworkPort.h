...
#ifndef _cimple_CIM_NetworkPort_h
#define _cimple_CIM_NetworkPort_h
...
/*[1194]*/
class CIM_NetworkPort : public Instance
{
public:
    ...
    CIMPLE_CLASS(CIM_NetworkPort)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_NetworkPort_RequestStateChange_method;

typedef CIM_LogicalDevice_SetPowerState_method CIM_NetworkPort_SetPowerState_method;

typedef CIM_LogicalDevice_Reset_method CIM_NetworkPort_Reset_method;

typedef CIM_LogicalDevice_EnableDevice_method CIM_NetworkPort_EnableDevice_method;

typedef CIM_LogicalDevice_OnlineDevice_method CIM_NetworkPort_OnlineDevice_method;

typedef CIM_LogicalDevice_QuiesceDevice_method CIM_NetworkPort_QuiesceDevice_method;

typedef CIM_LogicalDevice_SaveProperties_method CIM_NetworkPort_SaveProperties_method;

typedef CIM_LogicalDevice_RestoreProperties_method CIM_NetworkPort_RestoreProperties_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_NetworkPort_h */
