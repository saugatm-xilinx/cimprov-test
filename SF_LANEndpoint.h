...
#ifndef _cimple_SF_LANEndpoint_h
#define _cimple_SF_LANEndpoint_h
...
/*[1194]*/
class SF_LANEndpoint : public Instance
{
public:
    ...
    // SF_LANEndpoint features:

    CIMPLE_CLASS(SF_LANEndpoint)
};
...
#endif /* _cimple_SF_LANEndpoint_h */
