...
_CIM_Log_MaxNumberOfRecords =
{
    ...
    UINT64,
    0, /* subscript */
    CIMPLE_OFF(CIM_Log,MaxNumberOfRecords),
    0, /* value */
};
...
_CIM_Log_CurrentNumberOfRecords =
{
    ...
    UINT64,
    0, /* subscript */
    CIMPLE_OFF(CIM_Log,CurrentNumberOfRecords),
    0, /* value */
};
...
_CIM_Log_ClearLog_return_value =
{
    CIMPLE_ATOMIC_INITIALIZER, /* refs */
    ...
    UINT32,
    0,
    CIMPLE_OFF(CIM_Log_ClearLog_method,return_value),
    0, /* value */
};

/*[1911]*/
static Meta_Feature* _CIM_Log_ClearLog_MFA[] =
{
    (Meta_Feature*)(void*)&_CIM_Log_ClearLog_return_value
};

/*[2113]*/
const Meta_Method
CIM_Log_ClearLog_method::static_meta_class =
{
    CIMPLE_ATOMIC_INITIALIZER, /* refs */
    CIMPLE_FLAG_METHOD,
    "ClearLog",
    0, /* meta_qualifiers */
    0, /* num_meta_qaulifiers */
    _CIM_Log_ClearLog_MFA,
    CIMPLE_ARRAY_SIZE(_CIM_Log_ClearLog_MFA),
    sizeof(CIM_Log_ClearLog_method),
    UINT32,
};

/*[2291]*/
static Meta_Feature* _CIM_Log_MFA[] =
{
...
/*[2358]*/
const Meta_Class CIM_Log::static_meta_class =
{
    CIMPLE_ATOMIC_INITIALIZER, /* refs */
    ...
    0, /* num_meta_qaulifiers */
    _CIM_Log_MFA,
    CIMPLE_ARRAY_SIZE(_CIM_Log_MFA),
    sizeof(CIM_Log),
    _locals,
