...
#ifndef _cimple_CIM_RecordLog_h
#define _cimple_CIM_RecordLog_h
...
/*[1194]*/
class CIM_RecordLog : public Instance
{
public:
    ...
    CIMPLE_CLASS(CIM_RecordLog)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_RecordLog_RequestStateChange_method;

typedef CIM_Log_ClearLog_method CIM_RecordLog_ClearLog_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_RecordLog_h */
