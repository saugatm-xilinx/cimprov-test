...
#ifndef _cimple_SF_DiagnosticLog_h
#define _cimple_SF_DiagnosticLog_h
...
// SF_DiagnosticLog keys:
//     InstanceID

/*[1194]*/
class SF_DiagnosticLog : public Instance
{
public:
    ...
    // SF_DiagnosticLog features:

    CIMPLE_CLASS(SF_DiagnosticLog)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method SF_DiagnosticLog_RequestStateChange_method;

typedef CIM_Log_ClearLog_method SF_DiagnosticLog_ClearLog_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_SF_DiagnosticLog_h */
