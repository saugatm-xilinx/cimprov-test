...
#ifndef _cimple_CIM_ServiceAccessPoint_h
#define _cimple_CIM_ServiceAccessPoint_h
...
/*[1194]*/
class CIM_ServiceAccessPoint : public Instance
{
public:
    ...
    CIMPLE_CLASS(CIM_ServiceAccessPoint)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_ServiceAccessPoint_RequestStateChange_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_ServiceAccessPoint_h */
