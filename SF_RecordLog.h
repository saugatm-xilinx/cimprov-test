...
#ifndef _cimple_SF_RecordLog_h
#define _cimple_SF_RecordLog_h
...
/*[1194]*/
class SF_RecordLog : public Instance
{
public:
    ...
    // SF_RecordLog features:

    CIMPLE_CLASS(SF_RecordLog)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method SF_RecordLog_RequestStateChange_method;

typedef CIM_Log_ClearLog_method SF_RecordLog_ClearLog_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_SF_RecordLog_h */
