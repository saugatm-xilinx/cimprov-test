...
#ifndef _cimple_CIM_Controller_h
#define _cimple_CIM_Controller_h
...
/*[1194]*/
class CIM_Controller : public Instance
{
public:
    ...
    CIMPLE_CLASS(CIM_Controller)
};

typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_Controller_RequestStateChange_method;

typedef CIM_LogicalDevice_SetPowerState_method CIM_Controller_SetPowerState_method;

typedef CIM_LogicalDevice_Reset_method CIM_Controller_Reset_method;

typedef CIM_LogicalDevice_EnableDevice_method CIM_Controller_EnableDevice_method;

typedef CIM_LogicalDevice_OnlineDevice_method CIM_Controller_OnlineDevice_method;

typedef CIM_LogicalDevice_QuiesceDevice_method CIM_Controller_QuiesceDevice_method;

typedef CIM_LogicalDevice_SaveProperties_method CIM_Controller_SaveProperties_method;

typedef CIM_LogicalDevice_RestoreProperties_method CIM_Controller_RestoreProperties_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_Controller_h */
